...
| **Open Core + share-alike overlay** (opt-in) | + isolated OpenLigaDB Bundesliga/DFB/Frauen-Bundesliga display context | separate community fixture/result preview; ODbL notice shown; core facts unchanged |
